<script>
	...
	import AiFillFacebook from '../icons/AntDesignIcons/AiFillFacebook.svelte';
	import AiFillGithub from '../icons/AntDesignIcons/AiFillGithub.svelte';
	import AiFillMail from '../icons/AntDesignIcons/AiFillMail.svelte';
...
<div class="header-container">
	...
	<div class="div2">
		...
		<li>
			<a class="navlink" href="#accomplishments">Accomplishments</a>
		</li>
		<li>
	...
	<div class="div3">
		<a class="socialicons" href={Links[0].link}><AiFillGithub /></a>
		<a class="socialicons" href={Links[6].link}><AiFillMail /></a>
		<a class="socialicons" href={Links[5].link}><AiFillFacebook /></a>
		<a class="socialicons" href="/api-directory/"><AiFillApi /></a>
	</div>
</div>
